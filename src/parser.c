...
enum ts_symbol_identifiers {
  ...
  aux_sym_other_token1 = 22,
  aux_sym_word_other_token1 = 23,
  sym_vocabulary = 24,
  sym_identifier = 25,
  sym_arrow = 26,
  sym_double_arrow = 27,
  ...
  aux_sym_knot_repeat1 = 86,
  aux_sym_weave_body_repeat1 = 87,
  aux_sym_gather_mark_repeat1 = 88,
  aux_sym_option_text_repeat1 = 89,
  aux_sym_list_repeat1 = 90,
  aux_sym_text_repeat1 = 91,
  aux_sym_words_repeat1 = 92,
  aux_sym_divert_chain_repeat1 = 93,
  aux_sym_arguments_repeat1 = 94,
  aux_sym_condition_block_repeat1 = 95,
  aux_sym_condition_block_content_repeat1 = 96,
  aux_sym_inline_block_repeat1 = 97,
  aux_sym_identifier_path_repeat1 = 98,
  aux_sym_string_repeat1 = 99,
  aux_sym_other_repeat1 = 100,
  aux_sym_word_other_repeat1 = 101,
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 12:
      ...
      if (set_contains(extras_character_set_1, 10, lookahead)) ADVANCE(39);
      if (lookahead != 0 &&
    ...
    case 21:
      ACCEPT_TOKEN(aux_sym_gather_mark_token1);
      if (set_contains(sym_vocabulary_character_set_1, 477, lookahead)) ADVANCE(51);
      END_STATE();
    case 22:
    ...
    case 42:
      ...
      if (lookahead == 0xa0 ||
          ...
          lookahead == 0x205f ||
          lookahead == 0x3000) ADVANCE(42);
      if ((!eof && set_contains(aux_sym_other_token1_character_set_1, 479, lookahead))) ADVANCE(41);
      END_STATE();
    case 43:
      ACCEPT_TOKEN(aux_sym_other_token1);
      if (lookahead == '(') ADVANCE(23);
    ...
    case 48:
      ...
      if (lookahead == 0xa0 ||
          ...
          lookahead == 0x205f ||
          lookahead == 0x3000) ADVANCE(48);
      if ((!eof && set_contains(aux_sym_word_other_token1_character_set_1, 480, lookahead))) ADVANCE(47);
      END_STATE();
    case 49:
      ACCEPT_TOKEN(aux_sym_word_other_token1);
      if (lookahead == '-') ADVANCE(50);
...
static const TSLexMode ts_lex_modes[STATE_COUNT] = {
  ...
  [96] = {.lex_state = 7, .external_lex_state = 6},
  ...
  [138] = {.lex_state = 8, .external_lex_state = 9},
  [139] = {.lex_state = 2, .external_lex_state = 6},
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(155)] = 4102,
  [SMALL_STATE(156)] = 4119,
  ...
  [SMALL_STATE(191)] = 4690,
  [SMALL_STATE(192)] = 4706,
  [SMALL_STATE(193)] = 4722,
  [SMALL_STATE(194)] = 4735,
  [SMALL_STATE(195)] = 4748,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [139] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_text_repeat1, 2, 0, 0), SHIFT_REPEAT(114),
  [142] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_text_repeat1, 2, 0, 0), SHIFT_REPEAT(88),
  [145] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_text_repeat1, 2, 0, 0), SHIFT_REPEAT(92),
  ...
  [286] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_text_repeat1, 2, 0, 0), SHIFT_REPEAT(103),
  [289] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_text_repeat1, 2, 0, 0), SHIFT_REPEAT(136),
  [292] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_text_repeat1, 2, 0, 0), SHIFT_REPEAT(140),
  ...
  [317] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_knot, 2, 0, 0),
  [319] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_other_repeat1, 2, 0, 0),
  [321] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_other_repeat1, 2, 0, 0), SHIFT_REPEAT(88),
  [324] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_other_repeat1, 2, 0, 0),
  [326] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_knot, 3, 0, 0),
  ...
  [334] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_knot_repeat1, 2, 0, 0),
  [336] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_knot_repeat1, 2, 0, 0), SHIFT_REPEAT(246),
  [339] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_other, 1, 0, 0),
  [341] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_other, 1, 0, 0),
  [343] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition_block_content, 1, 0, 0),
  [345] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_condition_block_content_repeat1, 2, 0, 0), SHIFT_REPEAT(23),
  [348] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_condition_block_content_repeat1, 2, 0, 0), SHIFT_REPEAT(163),
  ...
  [355] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_divert_chain, 1, 0, 0),
  ...
  [363] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_text_repeat1, 1, 0, 0),
  [365] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_text_repeat1, 1, 0, 0),
  ...
  [371] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2, 0, 0), SHIFT_REPEAT(158),
  ...
  [382] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_identifier_path, 2, 0, 0),
  [384] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list, 3, 0, 0),
  [386] = {.entry = {.count = 1, .reusable = true}}, SHIFT(94),
  [388] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_identifier_path, 1, 0, 0),
  ...
  [396] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_identifier_path_repeat1, 2, 0, 0), SHIFT_REPEAT(202),
  [399] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_identifier_path_repeat1, 2, 0, 0),
  [401] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_other_repeat1, 2, 0, 0), SHIFT_REPEAT(136),
  ...
  [412] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_inline_block_repeat1, 2, 0, 0), SHIFT_REPEAT(116),
  [415] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_inline_block_repeat1, 2, 0, 0),
  [417] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_inline_block_repeat1, 2, 0, 0), SHIFT_REPEAT(164),
  ...
  [434] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_divert_chain_repeat1, 2, 0, 0), SHIFT_REPEAT(176),
  [437] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_divert_chain_repeat1, 2, 0, 0),
  [439] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_stitch, 2, 0, 0),
  [441] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_condition_block, 4, 0, 0),
  [443] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition_block, 4, 0, 0),
  [445] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_condition_block, 6, 0, 0),
  [447] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition_block, 6, 0, 0),
  ...
  [455] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_condition_block, 5, 0, 0),
  [457] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition_block, 5, 0, 0),
  ...
  [467] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_marked_identifier, 1, 0, 0),
  [469] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_knot_repeat1, 1, 0, 0),
  [471] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_comment_repeat1, 2, 0, 0), SHIFT_REPEAT(150),
  [474] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_comment_repeat1, 2, 0, 0), SHIFT_REPEAT(150),
  [477] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_block_comment_repeat1, 2, 0, 0),
  ...
  [489] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_argument, 1, 0, 0),
  [491] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_argument, 2, 0, 0),
  [493] = {.entry = {.count = 1, .reusable = true}}, SHIFT(102),
  [495] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_divert_continue, 1, 0, 0),
  [497] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2, 0, 0),
  [499] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2, 0, 0), SHIFT_REPEAT(155),
  [502] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2, 0, 0), SHIFT_REPEAT(155),
  [505] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_marked_identifier, 2, 0, 0),
  ...
  [537] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_list_repeat1, 2, 0, 0), SHIFT_REPEAT(130),
