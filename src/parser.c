...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [3] = {
    ...
    [sym_line_end] = ACTIONS(15),
  },
  [4] = {
    [sym_other] = STATE(4),
    [aux_sym_program_repeat1] = STATE(4),
    [aux_sym_other_token1] = ACTIONS(17),
    [sym_arrow] = ACTIONS(20),
    [sym_minus] = ACTIONS(20),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [17] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2, 0, 0), SHIFT_REPEAT(6),
  ...
  [27] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_other, 1, 0, 0),
  [29] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_program_repeat2, 2, 0, 0),
  [31] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat2, 2, 0, 0), SHIFT_REPEAT(2),
