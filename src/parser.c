...
enum ts_symbol_identifiers {
  ...
  aux_sym_knot_repeat1 = 23,
  aux_sym_body_repeat1 = 24,
  aux_sym_text_repeat1 = 25,
  aux_sym_vocabular_repeat1 = 26,
};
  ...
  switch (state) {
    case 0:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') ADVANCE(6);
      if (set_contains(aux_sym_vocabular_token1_character_set_1, 430, lookahead)) ADVANCE(8);
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [2] = {
    [sym_choice_text] = STATE(36),
    [sym_code_text] = STATE(36),
    [sym_dialog_text] = STATE(36),
    [sym_text] = STATE(34),
    [sym_vocabular] = STATE(8),
    [aux_sym_text_repeat1] = STATE(8),
    [aux_sym_vocabular_repeat1] = STATE(11),
    [aux_sym_choice_text_token1] = ACTIONS(9),
    [aux_sym_code_text_token1] = ACTIONS(11),
    [sym_other] = ACTIONS(13),
    [aux_sym_vocabular_token1] = ACTIONS(15),
    [anon_sym_DASH] = ACTIONS(15),
    [sym_minus] = ACTIONS(17),
    [sym_line_end] = ACTIONS(19),
  },
  [3] = {
    [sym_choice_text] = STATE(38),
    [sym_code_text] = STATE(38),
    [sym_dialog_text] = STATE(38),
    [sym_text] = STATE(34),
    [sym_vocabular] = STATE(8),
    [aux_sym_text_repeat1] = STATE(8),
    [aux_sym_vocabular_repeat1] = STATE(11),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [31] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_text, 1, 0, 0),
  [33] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_text_repeat1, 2, 0, 0), SHIFT_REPEAT(10),
  ...
  [44] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_vocabular, 1, 0, 0),
  [46] = {.entry = {.count = 1, .reusable = false}}, SHIFT(12),
  [48] = {.entry = {.count = 1, .reusable = true}}, SHIFT(12),
  [50] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_vocabular, 1, 0, 0),
  [52] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_vocabular_repeat1, 2, 0, 0),
  [54] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_vocabular_repeat1, 2, 0, 0), SHIFT_REPEAT(12),
  [57] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_vocabular_repeat1, 2, 0, 0), SHIFT_REPEAT(12),
  [60] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_vocabular_repeat1, 2, 0, 0),
  [62] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_body, 1, 0, 0),
  [64] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_body_repeat1, 2, 0, 0),
  [66] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_body_repeat1, 2, 0, 0), SHIFT_REPEAT(3),
  [69] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_body_repeat1, 2, 0, 0), SHIFT_REPEAT(2),
  [72] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_knot, 4, 0, 0),
  [74] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_knot, 5, 0, 0),
  [76] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_knot_repeat1, 2, 0, 0),
  [78] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_knot_repeat1, 2, 0, 0), SHIFT_REPEAT(9),
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_program, 2, 0, 0),
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_body_line, 2, 0, 0),
  ...
  [89] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2, 0, 0), SHIFT_REPEAT(6),
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_body_line, 3, 0, 0),
  [94] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_stitch, 4, 0, 0),
  ...
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dialog_text, 1, 0, 0),
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_choice_text, 2, 0, 0),
  [106] = {.entry = {.count = 1, .reusable = true}}, SHIFT(30),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_code_text, 2, 0, 0),
