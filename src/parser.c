...
enum ts_symbol_identifiers {
  ...
  sym_knot_header = 28,
  sym_stitch = 29,
  sym_stitch_header = 30,
  sym_weave_body = 31,
  sym_weave_body_line = 32,
  sym_function = 33,
  sym_gather_text = 34,
  sym_gather_mark = 35,
  sym_choice_text = 36,
  ...
  sym_divert_chain = 43,
  sym_divert = 44,
  sym_divert_continue = 45,
  sym_divert_return = 46,
  sym_function_header = 47,
  sym_arguments = 48,
  sym_condition_text = 49,
  sym_condition_block = 50,
  sym_identifier_path = 51,
  aux_sym_program_repeat1 = 52,
  aux_sym_knot_repeat1 = 53,
  aux_sym_weave_body_repeat1 = 54,
  aux_sym_gather_mark_repeat1 = 55,
  aux_sym_choice_mark_repeat1 = 56,
  aux_sym_text_repeat1 = 57,
  aux_sym_divert_chain_repeat1 = 58,
