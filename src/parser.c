...
enum ts_symbol_identifiers {
  ...
  sym_knot_header = 32,
  sym_stitch = 33,
  sym_stitch_header = 34,
  sym_weave_body = 35,
  sym_weave_body_line = 36,
  sym_function = 37,
  sym_gather_text = 38,
  sym_gather_mark = 39,
  sym_choice_text = 40,
  ...
  sym_divert_chain = 47,
  sym_divert = 48,
  sym_divert_continue = 49,
  sym_divert_return = 50,
  sym_function_header = 51,
  sym_arguments = 52,
  sym_condition_text = 53,
  sym_condition_block = 54,
  sym_identifier_path = 55,
  aux_sym_program_repeat1 = 56,
  aux_sym_knot_repeat1 = 57,
  aux_sym_weave_body_repeat1 = 58,
  aux_sym_gather_mark_repeat1 = 59,
  aux_sym_choice_mark_repeat1 = 60,
  aux_sym_text_repeat1 = 61,
  aux_sym_divert_chain_repeat1 = 62,
  aux_sym_arguments_repeat1 = 63,
  aux_sym_condition_block_repeat1 = 64,
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 1:
      ...
      if (set_contains(sym_identifier_character_set_1, 476, lookahead)) ADVANCE(34);
      END_STATE();
    case 2:
    ...
    case 7:
      ...
      if (set_contains(extras_character_set_1, 10, lookahead)) ADVANCE(24);
      if (lookahead != 0 &&
    ...
    case 11:
      ACCEPT_TOKEN(aux_sym_gather_mark_token1);
      if (set_contains(sym_vocabular_character_set_1, 477, lookahead)) ADVANCE(33);
      END_STATE();
    case 12:
    ...
    case 13:
      ACCEPT_TOKEN(aux_sym_choice_mark_token1);
      if ((!eof && set_contains(sym_other_character_set_1, 479, lookahead))) ADVANCE(31);
      END_STATE();
    case 14:
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  [0] = {
    ...
    [sym_block_comment_start] = ACTIONS(1),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_weave_body_repeat1, 2, 0, 0),
  [65] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_weave_body_repeat1, 2, 0, 0), SHIFT_REPEAT(3),
  [68] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_weave_body_repeat1, 2, 0, 0), SHIFT_REPEAT(140),
  [71] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_weave_body_repeat1, 2, 0, 0), SHIFT_REPEAT(141),
  [74] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_weave_body_repeat1, 2, 0, 0), SHIFT_REPEAT(11),
  ...
  [82] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_weave_body_repeat1, 2, 0, 0), SHIFT_REPEAT(132),
  [85] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_weave_body_repeat1, 2, 0, 0), SHIFT_REPEAT(100),
  ...
  [95] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2, 0, 0), SHIFT_REPEAT(96),
  [98] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2, 0, 0), SHIFT_REPEAT(93),
  [101] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_knot_header, 3, 0, 0),
  [103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_knot_header, 5, 0, 0),
  [105] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_program, 3, 0, 0),
  ...
  [111] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_knot_header, 4, 0, 0),
  ...
  [119] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_header, 6, 0, 0),
  ...
  [125] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_knot_repeat1, 2, 0, 0), SHIFT_REPEAT(99),
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_header, 3, 0, 0),
  [130] = {.entry = {.count = 1, .reusable = true}}, SHIFT(60),
  [132] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_divert_chain, 1, 0, 0),
  [134] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_knot, 3, 0, 0),
  [136] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dialog_text, 1, 0, 0),
  [138] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_gather_mark_repeat1, 2, 0, 0), SHIFT_REPEAT(36),
  [141] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_gather_mark_repeat1, 2, 0, 0),
  [143] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_gather_mark_repeat1, 2, 0, 0),
  [145] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_header, 5, 0, 0),
  [147] = {.entry = {.count = 1, .reusable = false}}, SHIFT(36),
  [149] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_gather_mark, 1, 0, 0),
  [151] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_gather_mark, 1, 0, 0),
  [153] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_knot, 2, 0, 0),
  [155] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_header, 7, 0, 0),
  [157] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_header, 8, 0, 0),
  ...
  [199] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_divert_chain_repeat1, 2, 0, 0), SHIFT_REPEAT(91),
  ...
  [220] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2, 0, 0), SHIFT_REPEAT(119),
  [223] = {.entry = {.count = 1, .reusable = false}}, SHIFT(65),
  [225] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition_text, 1, 0, 0),
  [227] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_stitch, 2, 0, 0),
  [229] = {.entry = {.count = 1, .reusable = true}}, SHIFT(62),
  [231] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_divert_continue, 1, 0, 0),
  ...
  [243] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_text_repeat1, 2, 0, 0), SHIFT_REPEAT(66),
  ...
  [252] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_divert, 2, 0, 0),
  [254] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function, 2, 0, 0),
  [256] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_condition_block, 4, 0, 0),
  [258] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition_block, 4, 0, 0),
  [260] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_divert_chain, 2, 0, 0),
  [262] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_identifier_path, 3, 0, 0),
  ...
  [274] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_condition_block, 5, 0, 0),
  [276] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition_block, 5, 0, 0),
  [278] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_condition_block, 6, 0, 0),
  [280] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition_block, 6, 0, 0),
  [282] = {.entry = {.count = 1, .reusable = true}}, SHIFT(108),
  [284] = {.entry = {.count = 1, .reusable = true}}, SHIFT(24),
  [286] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_condition_block_repeat1, 2, 0, 0), SHIFT_REPEAT(89),
  ...
  [329] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_divert_chain, 3, 0, 0),
  [331] = {.entry = {.count = 1, .reusable = true}}, SHIFT(116),
  [333] = {.entry = {.count = 1, .reusable = true}}, SHIFT(20),
  [335] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_code_text, 2, 0, 0),
  [337] = {.entry = {.count = 1, .reusable = true}}, SHIFT(95),
  [339] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_condition_block_repeat1, 3, 0, 0),
  ...
  [349] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_gather_text, 2, 0, 0),
  [351] = {.entry = {.count = 1, .reusable = true}}, SHIFT(43),
  [353] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_choice_text, 2, 0, 0),
  [355] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dialog_text, 2, 0, 0),
  [357] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition_text, 2, 0, 0),
  [359] = {.entry = {.count = 1, .reusable = true}}, SHIFT(39),
  [361] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_divert_return, 1, 0, 0),
  ...
  [369] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_condition_block_repeat1, 2, 0, 0),
