...
enum ts_symbol_identifiers {
  ...
  aux_sym_function_header_token1 = 8,
  aux_sym_function_header_token2 = 9,
  aux_sym_arguments_token1 = 10,
  ...
  sym_knot_header = 38,
  sym_stitch = 39,
  sym_stitch_header = 40,
  sym_weave_body = 41,
  sym_weave_body_line = 42,
  sym_function = 43,
  sym_gather_text = 44,
  sym_gather_mark = 45,
  sym_choice_text = 46,
  ...
  sym_divert_chain = 53,
  sym_divert = 54,
  sym_divert_continue = 55,
  sym_divert_return = 56,
  sym_function_header = 57,
  sym_arguments = 58,
  sym_condition_text = 59,
  sym_condition_block = 60,
  sym_identifier_path = 61,
  sym_value = 62,
  sym_string = 63,
  aux_sym_program_repeat1 = 64,
  aux_sym_block_comment_repeat1 = 65,
  aux_sym_knot_repeat1 = 66,
  aux_sym_weave_body_repeat1 = 67,
  aux_sym_gather_mark_repeat1 = 68,
  aux_sym_choice_mark_repeat1 = 69,
  aux_sym_text_repeat1 = 70,
  aux_sym_divert_chain_repeat1 = 71,
...
static const TSLexMode ts_lex_modes[STATE_COUNT] = {
  ...
  [92] = {.lex_state = 9, .external_lex_state = 6},
  ...
  [100] = {.lex_state = 9, .external_lex_state = 6},
  ...
  [107] = {.lex_state = 9, .external_lex_state = 6},
  ...
  [157] = {.lex_state = 8, .external_lex_state = 8},
  [158] = {.lex_state = 8, .external_lex_state = 8},
  [159] = {.lex_state = 8, .external_lex_state = 8},
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_weave_body_line] = STATE(50),
    [sym_function] = STATE(102),
    [sym_var_line] = STATE(50),
    [sym_const_line] = STATE(50),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [59] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_weave_body, 1, 0, 0),
  [61] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_choice_text, 1, 0, 0),
  ...
  [70] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_weave_body_repeat1, 2, 0, 0), SHIFT_REPEAT(160),
  [73] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_weave_body_repeat1, 2, 0, 0), SHIFT_REPEAT(161),
  [76] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_weave_body_repeat1, 2, 0, 0), SHIFT_REPEAT(24),
  [79] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_weave_body_repeat1, 2, 0, 0), SHIFT_REPEAT(2),
  [82] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_weave_body_repeat1, 2, 0, 0), SHIFT_REPEAT(124),
  [85] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_weave_body_repeat1, 2, 0, 0), SHIFT_REPEAT(134),
  [88] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_weave_body_repeat1, 2, 0, 0), SHIFT_REPEAT(50),
  ...
  [95] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2, 0, 0), SHIFT_REPEAT(119),
  ...
  [103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_program, 3, 0, 0),
  [105] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_knot_header, 4, 0, 0),
  [107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_stitch_header, 3, 0, 0),
  [109] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_knot_header, 5, 0, 0),
  [111] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_weave_body_repeat1, 1, 0, 0),
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_weave_body_line, 2, 0, 0),
  [115] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_weave_body_line, 3, 0, 0),
  [117] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_var_line, 5, 0, 0),
  [119] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_const_line, 5, 0, 0),
  [121] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_header, 8, 0, 0),
  [123] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_choice_mark_repeat1, 2, 0, 0), SHIFT_REPEAT(56),
  [126] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_choice_mark_repeat1, 2, 0, 0),
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_choice_mark_repeat1, 2, 0, 0),
  ...
  [138] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_divert_chain, 1, 0, 0),
  [140] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_knot_repeat1, 2, 0, 0),
  [142] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_knot_repeat1, 2, 0, 0), SHIFT_REPEAT(136),
  ...
  [153] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_header, 4, 0, 0),
  [155] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_gather_mark, 1, 0, 0),
  [157] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_gather_mark, 1, 0, 0),
  ...
  [169] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_knot, 2, 0, 0),
  [171] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_gather_mark_repeat1, 2, 0, 0), SHIFT_REPEAT(57),
  [174] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_gather_mark_repeat1, 2, 0, 0),
  [176] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_gather_mark_repeat1, 2, 0, 0),
  ...
  [188] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_text_repeat1, 2, 0, 0), SHIFT_REPEAT(59),
  [191] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_text_repeat1, 2, 0, 0),
  ...
  [201] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_text, 1, 0, 0),
  [203] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_choice_mark_repeat1, 1, 0, 0),
  [205] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_choice_mark_repeat1, 1, 0, 0),
  ...
  [213] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_text_repeat1, 1, 0, 0),
  [215] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_text_repeat1, 1, 0, 0),
  [217] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_divert_chain_repeat1, 2, 0, 0), SHIFT_REPEAT(121),
  [220] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_divert_chain_repeat1, 2, 0, 0),
  ...
  [232] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2, 0, 0),
  [234] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2, 0, 0), SHIFT_REPEAT(81),
  [237] = {.entry = {.count = 1, .reusable = false}}, SHIFT(104),
  [239] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition_text, 1, 0, 0),
  [241] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2, 0, 0),
  [243] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2, 0, 0), SHIFT_REPEAT(96),
  [246] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2, 0, 0), SHIFT_REPEAT(96),
  [249] = {.entry = {.count = 1, .reusable = true}}, SHIFT(84),
  [251] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_divert_continue, 1, 0, 0),
  ...
  [259] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_stitch, 2, 0, 0),
  ...
  [269] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_knot_repeat1, 1, 0, 0),
  ...
  [277] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_comment_repeat1, 2, 0, 0), SHIFT_REPEAT(93),
  [280] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_comment_repeat1, 2, 0, 0), SHIFT_REPEAT(93),
  [283] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_block_comment_repeat1, 2, 0, 0),
  [285] = {.entry = {.count = 1, .reusable = true}}, SHIFT(137),
  [287] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_identifier_path, 1, 0, 0),
  [289] = {.entry = {.count = 1, .reusable = true}}, SHIFT(163),
  [291] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_text_repeat1, 2, 0, 0), SHIFT_REPEAT(104),
  [294] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_identifier_path, 3, 0, 0),
  [296] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_condition_block, 4, 0, 0),
  [298] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition_block, 4, 0, 0),
  ...
  [306] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_block_comment_repeat1, 1, 0, 0),
  [308] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_block_comment_repeat1, 1, 0, 0),
  ...
  [316] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_divert_chain, 2, 0, 0),
  [318] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 1, 0, 0),
  [320] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 1, 0, 0),
  [322] = {.entry = {.count = 1, .reusable = false}}, SHIFT(91),
  [324] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_divert_chain_repeat1, 1, 0, 0),
  [326] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_condition_block, 5, 0, 0),
  [328] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition_block, 5, 0, 0),
  [330] = {.entry = {.count = 1, .reusable = false}}, SHIFT(101),
  [332] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_condition_block, 6, 0, 0),
  [334] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition_block, 6, 0, 0),
  [336] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 1, 0, 0),
  [338] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_divert, 2, 0, 0),
  [340] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function, 2, 0, 0),
  ...
  [356] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_condition_block_repeat1, 2, 0, 0), SHIFT_REPEAT(107),
  ...
  [385] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_condition_block_repeat1, 3, 0, 0),
  ...
  [399] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_condition_block_repeat1, 2, 0, 0),
  [401] = {.entry = {.count = 1, .reusable = true}}, SHIFT(130),
  [403] = {.entry = {.count = 1, .reusable = true}},  ACCEPT_INPUT(),
  [405] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_divert_return, 1, 0, 0),
  [407] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_code_text, 2, 0, 0),
  [409] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_divert_chain, 3, 0, 0),
  ...
  [417] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_gather_text, 2, 0, 0),
  [419] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_choice_text, 2, 0, 0),
  [421] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dialog_text, 2, 0, 0),
  [423] = {.entry = {.count = 1, .reusable = true}}, SHIFT(26),
  [425] = {.entry = {.count = 1, .reusable = true}}, SHIFT(27),
  [427] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition_text, 2, 0, 0),
  ...
  [441] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block_comment, 2, 0, 0),
  [443] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block_comment, 3, 0, 0),
};
